...
public class CustomerController {
    ...
    public Page<Customer> getAllCustomers(@RequestParam(defaultValue = "1") int page,
        ...
        return customerService.getAllCustomers(paging);
    }

    @PostMapping("/search")
    public Page<Customer> searchCustomers(@RequestBody SearchCustomer searchCustomer,
                                          @RequestParam(defaultValue = "1") int page,
                                          @RequestParam(defaultValue = "10") int size) {
        Paging paging = new Paging(page, size);
        return customerService.searchCustomers(searchCustomer, paging);
    }
